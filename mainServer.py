...
#     print("Vector o matriz rotado 90 grados:", rotated_vector_or_matrix)
    ...
    coordV.append(rotated_vector_or_matrix[1])
...
#             centrU, centrV, angCamera =
            ...
            dst, angle_values, angle = computeAngle(frame,mtx,dist,angle_values)
